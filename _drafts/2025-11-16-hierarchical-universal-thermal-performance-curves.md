...
time (~10 generations = “acclimation”, ~100 generations = “adaptation”)
...
specification. The pawar_2018 model has five parameters: $`t_{ref}`$ is
an “anchor” parameter that is fixed, being the temperature at which the
$`r_{tref}`$ rate is estimated. $`t_{ref}`$ should be below $`t_{opt}`$,
the temperature at which the rate peaks. That rate is informed by the
activation energy $`e`$ and the deactivation energy $`eh`$, which
control the rate of incline and decline. $`e`$ cannot be greater than
$`eh`$. The `rTPC::get_start_vals()` function is a convenient way to get
an idea of plausible values for these parameters.
...
```
    ...
    ## Chain 2 Exception: Rejecting proposal as e > eh is a-priori impossible. (in '/tmp/RtmpI9YkLH/model-396cd7baaab56.stan', line 49, column 4 to column 67)
    ...
    ## Chain 1 Iteration: 3000 / 4000 [ 75%]  (Warmup) 
    ## Chain 1 Iteration: 3001 / 4000 [ 75%]  (Sampling) 
    ## Chain 3 Iteration: 3000 / 4000 [ 75%]  (Warmup) 
    ## Chain 3 Iteration: 3001 / 4000 [ 75%]  (Sampling) 
    ## Chain 4 Iteration: 3000 / 4000 [ 75%]  (Warmup) 
    ## Chain 4 Iteration: 3001 / 4000 [ 75%]  (Sampling) 
    ## Chain 2 Iteration: 3000 / 4000 [ 75%]  (Warmup) 
...
![](../assets/img/2025-11-16-hierarchical-universal-thermal-performance-curves/unnamed-chunk-2-2.png)<!-- -->
...
```
    ...
    ## Chain 1 Exception: Rejecting proposal as e > eh is a-priori impossible. (in '/tmp/RtmpI9YkLH/model-396cd6090249f.stan', line 56, column 4 to column 67)
    ...
    ## Chain 3 Exception: Rejecting proposal as e > eh is a-priori impossible. (in '/tmp/RtmpI9YkLH/model-396cd6090249f.stan', line 56, column 4 to column 67)
...
```
    ...
    ## Total execution time: 70.1 seconds.

    ## Warning: 955 of 4000 (24.0%) transitions ended with a divergence.
...
![](../assets/img/2025-11-16-hierarchical-universal-thermal-performance-curves/unnamed-chunk-3-1.png)<!-- -->
...
optimal temperature $`T_{opt}`$, the rate at that optimum $`y_{opt}`$,
and the difference between $`T_{opt}`$ and the critical upper limit
$`Delta`$. Temperature is in Celcius (I know, crazy!).
...
```
    ...
    ## ~curve_id (Number of levels: 3) 
    ##                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(yopt_Intercept)      0.26      0.15     0.02     0.59 1.13       22       77
    ## sd(Topt_Intercept)      1.00      1.16     0.01     3.49 1.53        7       33
    ## sd(Delta_Intercept)     0.67      0.86     0.01     2.36 1.53        7       39
    ## 
    ## Regression Coefficients:
    ##                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## yopt_Intercept      2.14      0.15     1.83     2.43 1.03      274     1220
    ## Topt_Intercept     38.55      1.39    34.54    39.93 1.40        9       34
    ## Delta_Intercept     5.63      2.55     0.27     7.67 1.53        7       31
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.28      0.08     0.19     0.45 1.53        7       31
    ## 
    ## Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Warning: Found 6 observations with a pareto_k > 0.7 in model 'm_UTPC'. We
...
and lower $`Delta`$, i.e., a steeper drop-off and a narrower range of
good performance.
...
```
    ...
    ## sd(yopt_Intercept:growth_temp_fct27)      0.10      0.09     0.00     0.35 1.00
    ## sd(yopt_Intercept:growth_temp_fct30)      0.22      0.13     0.03     0.52 1.00
    ## sd(yopt_Intercept:growth_temp_fct33)      0.30      0.13     0.11     0.60 1.00
    ## sd(Topt_Intercept:growth_temp_fct27)      0.33      0.32     0.01     1.16 1.00
    ## sd(Topt_Intercept:growth_temp_fct30)      0.36      0.34     0.01     1.24 1.00
    ## sd(Topt_Intercept:growth_temp_fct33)      0.32      0.33     0.01     1.24 1.00
    ## sd(Delta_Intercept:growth_temp_fct27)     0.18      0.15     0.01     0.55 1.00
    ## sd(Delta_Intercept:growth_temp_fct30)     0.21      0.16     0.01     0.59 1.00
    ## sd(Delta_Intercept:growth_temp_fct33)     0.18      0.14     0.01     0.54 1.00
    ##                                       Bulk_ESS Tail_ESS
    ## sd(yopt_Intercept:growth_temp_fct27)      1134     1272
    ## sd(yopt_Intercept:growth_temp_fct30)       845      734
    ## sd(yopt_Intercept:growth_temp_fct33)      1061     1133
    ## sd(Topt_Intercept:growth_temp_fct27)       827      998
    ## sd(Topt_Intercept:growth_temp_fct30)      1034      677
    ## sd(Topt_Intercept:growth_temp_fct33)       871      819
    ## sd(Delta_Intercept:growth_temp_fct27)     1114      803
    ## sd(Delta_Intercept:growth_temp_fct30)     1183      748
    ## sd(Delta_Intercept:growth_temp_fct33)     1447      973
    ## 
    ## Regression Coefficients:
    ##                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    ## yopt_growth_temp_fct27      2.10      0.09     1.90     2.27 1.00     1511
    ## yopt_growth_temp_fct30      1.79      0.13     1.54     2.07 1.00      918
    ## yopt_growth_temp_fct33      2.17      0.16     1.84     2.45 1.00      817
    ## Topt_growth_temp_fct27     38.69      0.40    37.97    39.46 1.00     1238
    ## Topt_growth_temp_fct30     38.89      0.43    38.08    39.69 1.00     1259
    ## Topt_growth_temp_fct33     39.16      0.33    38.49    39.79 1.00     1662
    ## Delta_growth_temp_fct27     7.76      0.32     7.17     8.40 1.00     1556
    ## Delta_growth_temp_fct30     7.61      0.38     6.91     8.36 1.00     1560
    ## Delta_growth_temp_fct33     7.07      0.29     6.49     7.65 1.00     1626
    ##                         Tail_ESS
    ## yopt_growth_temp_fct27      1057
    ## yopt_growth_temp_fct30      1178
    ## yopt_growth_temp_fct33      1006
    ## Topt_growth_temp_fct27       850
    ## Topt_growth_temp_fct30      1219
    ## Topt_growth_temp_fct33      1488
    ## Delta_growth_temp_fct27     1349
    ## Delta_growth_temp_fct30     1496
    ## Delta_growth_temp_fct33     1432
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.21      0.02     0.18     0.25 1.00     2024     1634
    ## 
    ## Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
This model can have some trouble sampling, so I tried reformulating it
in logarithmic form. The formula then becomes:
...
```
    ...
    ## Chain 1 Exception: lognormal_lpdf: Location parameter[1] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 1 Rejecting initial value:

    ## Chain 1   Error evaluating the log probability at the initial value.

    ## Chain 1 Exception: lognormal_lpdf: Location parameter[10] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 1 Rejecting initial value:

    ## Chain 1   Error evaluating the log probability at the initial value.

    ## Chain 1 Exception: lognormal_lpdf: Location parameter[9] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 1 Rejecting initial value:

    ## Chain 1   Error evaluating the log probability at the initial value.

    ## Chain 1 Exception: lognormal_lpdf: Location parameter[44] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 1 Exception: lognormal_lpdf: Location parameter[12] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 1 Rejecting initial value:

    ## Chain 1   Error evaluating the log probability at the initial value.

    ## Chain 1 Exception: lognormal_lpdf: Location parameter[8] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 1 Exception: lognormal_lpdf: Location parameter[11] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 1 Exception: lognormal_lpdf: Location parameter[34] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 1 Exception: lognormal_lpdf: Location parameter[67] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 1 Rejecting initial value:

    ## Chain 1   Error evaluating the log probability at the initial value.

    ## Chain 1 Exception: lognormal_lpdf: Location parameter[43] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 1 Exception: lognormal_lpdf: Location parameter[22] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 2 Exception: lognormal_lpdf: Location parameter[75] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 2 Rejecting initial value:

    ## Chain 2   Error evaluating the log probability at the initial value.

    ## Chain 2 Exception: lognormal_lpdf: Location parameter[9] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 2 Rejecting initial value:

    ## Chain 2   Error evaluating the log probability at the initial value.

    ## Chain 2 Exception: lognormal_lpdf: Location parameter[45] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 2 Rejecting initial value:

    ## Chain 2   Error evaluating the log probability at the initial value.

    ## Chain 2 Exception: lognormal_lpdf: Location parameter[10] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 2 Rejecting initial value:

    ## Chain 2   Error evaluating the log probability at the initial value.

    ## Chain 2 Exception: lognormal_lpdf: Location parameter[11] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 2 Rejecting initial value:

    ## Chain 2   Error evaluating the log probability at the initial value.

    ## Chain 2 Exception: lognormal_lpdf: Location parameter[42] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 2 Rejecting initial value:

    ## Chain 2   Error evaluating the log probability at the initial value.

    ## Chain 2 Exception: lognormal_lpdf: Location parameter[78] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 3 Exception: lognormal_lpdf: Location parameter[10] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[33] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[77] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[8] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[67] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[1] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[9] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[23] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 3 Rejecting initial value:

    ## Chain 3   Error evaluating the log probability at the initial value.

    ## Chain 3 Exception: lognormal_lpdf: Location parameter[45] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 4 Exception: lognormal_lpdf: Location parameter[87] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 4 Rejecting initial value:

    ## Chain 4   Error evaluating the log probability at the initial value.

    ## Chain 4 Exception: lognormal_lpdf: Location parameter[77] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 4 Rejecting initial value:

    ## Chain 4   Error evaluating the log probability at the initial value.

    ## Chain 4 Exception: lognormal_lpdf: Location parameter[43] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 4 Rejecting initial value:

    ## Chain 4   Error evaluating the log probability at the initial value.

    ## Chain 4 Exception: lognormal_lpdf: Location parameter[7] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 4 Rejecting initial value:

    ## Chain 4   Error evaluating the log probability at the initial value.

    ## Chain 4 Exception: lognormal_lpdf: Location parameter[1] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 4 Rejecting initial value:

    ## Chain 4   Error evaluating the log probability at the initial value.

    ## Chain 4 Exception: lognormal_lpdf: Location parameter[11] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 4 Exception: lognormal_lpdf: Location parameter[9] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 4 Exception: lognormal_lpdf: Location parameter[34] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 4 Rejecting initial value:

    ## Chain 4   Error evaluating the log probability at the initial value.

    ## Chain 4 Exception: lognormal_lpdf: Location parameter[10] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 4 Exception: lognormal_lpdf: Location parameter[23] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 4 Exception: lognormal_lpdf: Location parameter[12] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)

    ## Chain 4 Rejecting initial value:

    ## Chain 4   Error evaluating the log probability at the initial value.

    ## Chain 4 Exception: lognormal_lpdf: Location parameter[21] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
    ...
    ## Chain 4 Exception: lognormal_lpdf: Location parameter[33] is -nan, but must be finite! (in '/tmp/RtmpI9YkLH/model-396cd79829b92.stan', line 109, column 4 to column 44)
...
```
    ...
    ## ~curve_id (Number of levels: 9) 
    ##                                       Estimate Est.Error l-95% CI u-95% CI Rhat
    ## sd(yopt_Intercept:growth_temp_fct27)      0.12      0.11     0.01     0.41 1.00
    ## sd(yopt_Intercept:growth_temp_fct30)      0.25      0.14     0.04     0.57 1.00
    ## sd(yopt_Intercept:growth_temp_fct33)      0.28      0.15     0.04     0.63 1.01
    ## sd(Topt_Intercept:growth_temp_fct27)      0.21      0.24     0.00     0.92 1.00
    ## sd(Topt_Intercept:growth_temp_fct30)      0.25      0.28     0.01     1.06 1.00
    ## sd(Topt_Intercept:growth_temp_fct33)      0.21      0.28     0.00     1.10 1.00
    ## sd(Delta_Intercept:growth_temp_fct27)     0.14      0.12     0.00     0.47 1.00
    ## sd(Delta_Intercept:growth_temp_fct30)     0.20      0.16     0.01     0.58 1.00
    ## sd(Delta_Intercept:growth_temp_fct33)     0.14      0.13     0.00     0.47 1.00
    ##                                       Bulk_ESS Tail_ESS
    ## sd(yopt_Intercept:growth_temp_fct27)      1373     1084
    ## sd(yopt_Intercept:growth_temp_fct30)       922      729
    ## sd(yopt_Intercept:growth_temp_fct33)       804      639
    ## sd(Topt_Intercept:growth_temp_fct27)       915     1128
    ## sd(Topt_Intercept:growth_temp_fct30)       812     1173
    ## sd(Topt_Intercept:growth_temp_fct33)       663      470
    ## sd(Delta_Intercept:growth_temp_fct27)     1323     1083
    ## sd(Delta_Intercept:growth_temp_fct30)      775      691
    ## sd(Delta_Intercept:growth_temp_fct33)     1081     1340
    ## 
    ## Regression Coefficients:
    ##                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    ## yopt_growth_temp_fct27      2.07      0.12     1.84     2.33 1.00     1579
    ## yopt_growth_temp_fct30      1.79      0.15     1.52     2.13 1.00     1120
    ## yopt_growth_temp_fct33      2.14      0.17     1.80     2.47 1.00     1143
    ## Topt_growth_temp_fct27     38.81      0.29    38.23    39.32 1.00     1231
    ## Topt_growth_temp_fct30     38.79      0.30    38.17    39.36 1.00     1491
    ## Topt_growth_temp_fct33     39.49      0.30    38.88    40.03 1.00      562
    ## Delta_growth_temp_fct27     7.71      0.28     7.19     8.28 1.00     1662
    ## Delta_growth_temp_fct30     7.73      0.31     7.14     8.38 1.00     1643
    ## Delta_growth_temp_fct33     6.80      0.23     6.34     7.25 1.00     1632
    ##                         Tail_ESS
    ## yopt_growth_temp_fct27      1175
    ## yopt_growth_temp_fct30      1189
    ## yopt_growth_temp_fct33      1263
    ## Topt_growth_temp_fct27      1308
    ## Topt_growth_temp_fct30      1163
    ## Topt_growth_temp_fct33       439
    ## Delta_growth_temp_fct27     1475
    ## Delta_growth_temp_fct30     1149
    ## Delta_growth_temp_fct33     1165
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.21      0.02     0.18     0.24 1.00     2014     1379
    ## 
    ## Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
![](../assets/img/2025-11-16-hierarchical-universal-thermal-performance-curves/unnamed-chunk-4-1.png)<!-- -->
...
0.7 $`{^\circ}C`$) but lower $`Delta`$ (by around 0.9 $`{^\circ}C`$)
than those grown at lower temperatures, implying that the upper thermal
limit didn’t change, or may have even declined…
...
![](../assets/img/2025-11-16-hierarchical-universal-thermal-performance-curves/unnamed-chunk-5-1.png)<!-- -->
